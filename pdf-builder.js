// PDF BUILDER — Sprechen B2 Medien & Kommunikation (Reisen)
(function () {
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Vocabular Medien & Kommunikation (B2 Sprechen)</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex3Data !== 'undefined') {
            html += fillInBlock('Übung 3 — Vocabular Medien & Kommunikation în context (substantive cheie)', 'Jobangebot, Gehalt, Probezeit, Aufstiegschancen, Arbeitszeiten, Risiko, Gehaltserhöhung, Vertrag — cuvinte cheie pentru descrierea situației.', ex3Data);
        }
